...
class EventsApi
{
    ...
    /**
     * Operation eposEventsPost
     *
     * Submit an event
     *
     * @param  \Dojo_PHP\Model\EventRequest $event_request event_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['eposEventsPost'] to see the possible values for this operation
     *
     * @throws \Dojo_PHP\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Dojo_PHP\Model\EventRequest
     */
    public function eposEventsPost($event_request, string $contentType = self::contentTypes['eposEventsPost'][0])
    {
        list($response) = $this->eposEventsPostWithHttpInfo($event_request, $contentType);
        return $response;
    }

    /**
     * Operation eposEventsPostWithHttpInfo
     *
     * Submit an event
     *
     * @param  \Dojo_PHP\Model\EventRequest $event_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['eposEventsPost'] to see the possible values for this operation
     *
     * @throws \Dojo_PHP\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Dojo_PHP\Model\EventRequest, HTTP status code, HTTP response headers (array of strings)
     */
    public function eposEventsPostWithHttpInfo($event_request, string $contentType = self::contentTypes['eposEventsPost'][0])
    {
        $request = $this->eposEventsPostRequest($event_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Dojo_PHP\Model\EventRequest' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Dojo_PHP\Model\EventRequest' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Dojo_PHP\Model\EventRequest', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Dojo_PHP\Model\EventRequest';
     ...
     */
    public function eposEventsPostAsync($event_request, string $contentType = self::contentTypes['eposEventsPost'][0])
    {
        return $this->eposEventsPostAsyncWithHttpInfo($event_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation eposEventsPostAsyncWithHttpInfo
     *
     * Submit an event
     *
     * @param  \Dojo_PHP\Model\EventRequest $event_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function eposEventsPostAsyncWithHttpInfo($event_request, string $contentType = self::contentTypes['eposEventsPost'][0])
    {
        $returnType = '\Dojo_PHP\Model\EventRequest';
        $request = $this->eposEventsPostRequest($event_request, $contentType);
    ...
    /**
     * Create request for operation 'eposEventsPost'
     *
     * @param  \Dojo_PHP\Model\EventRequest $event_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['eposEventsPost'] to see the possible values for this operation
     *
     ...
     */
    public function eposEventsPostRequest($event_request, string $contentType = self::contentTypes['eposEventsPost'][0])
    {
        ...
        if ($event_request === null || (is_array($event_request) && count($event_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $event_request when calling eposEventsPost'
            );
        }


        $resourcePath = '/epos/events';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
