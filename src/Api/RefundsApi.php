...
/**
    ...
    /**
     * Operation paymentIntentsGetRefundById
     *
     * Retrieve a refund
     *
     * @param  \DateTime $version The API version with format yyyy-mm-dd. The current version is &#x60;Pre-release&#x60;. (required)
     * @param  string $refund_id The unique identifier for the refund. (required)
     ...
     * @return \Dojo_PHP\Model\Refund|\Dojo_PHP\Model\ProblemDetails|\Dojo_PHP\Model\ProblemDetails
     */
    public function paymentIntentsGetRefundById($version, $refund_id, string $contentType = self::contentTypes['paymentIntentsGetRefundById'][0])
    {
        list($response) = $this->paymentIntentsGetRefundByIdWithHttpInfo($version, $refund_id, $contentType);
        return $response;
    }

    /**
     * Operation paymentIntentsGetRefundByIdWithHttpInfo
     *
     * Retrieve a refund
     *
     * @param  \DateTime $version The API version with format yyyy-mm-dd. The current version is &#x60;Pre-release&#x60;. (required)
     ...
     * @throws \Dojo_PHP\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Dojo_PHP\Model\Refund|\Dojo_PHP\Model\ProblemDetails|\Dojo_PHP\Model\ProblemDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentIntentsGetRefundByIdWithHttpInfo($version, $refund_id, string $contentType = self::contentTypes['paymentIntentsGetRefundById'][0])
    {
        $request = $this->paymentIntentsGetRefundByIdRequest($version, $refund_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Dojo_PHP\Model\Refund' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Dojo_PHP\Model\Refund' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Dojo_PHP\Model\Refund', []),
            ...
            $returnType = '\Dojo_PHP\Model\Refund';
    ...
    /**
     * Operation paymentIntentsGetRefundByIdAsync
     *
     * Retrieve a refund
     *
     * @param  \DateTime $version The API version with format yyyy-mm-dd. The current version is &#x60;Pre-release&#x60;. (required)
     ...
     */
    public function paymentIntentsGetRefundByIdAsync($version, $refund_id, string $contentType = self::contentTypes['paymentIntentsGetRefundById'][0])
    {
        return $this->paymentIntentsGetRefundByIdAsyncWithHttpInfo($version, $refund_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation paymentIntentsGetRefundByIdAsyncWithHttpInfo
     *
     * Retrieve a refund
     *
     * @param  \DateTime $version The API version with format yyyy-mm-dd. The current version is &#x60;Pre-release&#x60;. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentIntentsGetRefundByIdAsyncWithHttpInfo($version, $refund_id, string $contentType = self::contentTypes['paymentIntentsGetRefundById'][0])
    {
        $returnType = '\Dojo_PHP\Model\Refund';
        $request = $this->paymentIntentsGetRefundByIdRequest($version, $refund_id, $contentType);
     ...
     */
    public function paymentIntentsGetRefundByIdRequest($version, $refund_id, string $contentType = self::contentTypes['paymentIntentsGetRefundById'][0])
    {

        // verify the required parameter 'version' is set
        if ($version === null || (is_array($version) && count($version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $version when calling paymentIntentsGetRefundById'
            );
        }
        ...
        if ($refund_id === null || (is_array($refund_id) && count($refund_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $refund_id when calling paymentIntentsGetRefundById'
            );
        }
        if (strlen($refund_id) > 50) {
            throw new \InvalidArgumentException('invalid length for "$refund_id" when calling RefundsApi.paymentIntentsGetRefundById, must be smaller than or equal to 50.');
        }
        

        $resourcePath = '/payment-intents/refunds/{refundId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \DateTime $version The API version with format yyyy-mm-dd. The current version is &#x60;Pre-release&#x60;. (required)
     * @param  string $payment_intent_id The unique identifier for the payment intent. (required)
     * @param  string $idempotency_key An idempotency key to recognize subsequent retries of the same request. How you generate the idempotency key is up to you. The key must be unique for each new refund processed on the payment intent. (required)
     ...
     * @return \Dojo_PHP\Model\Refund|\Dojo_PHP\Model\ProblemDetails|\Dojo_PHP\Model\ProblemDetails
     */
    public function refundsCreate($version, $payment_intent_id, $idempotency_key, $create_refund_request, string $contentType = self::contentTypes['refundsCreate'][0])
    {
        list($response) = $this->refundsCreateWithHttpInfo($version, $payment_intent_id, $idempotency_key, $create_refund_request, $contentType);
        return $response;
    }
     ...
     * @return array of \Dojo_PHP\Model\Refund|\Dojo_PHP\Model\ProblemDetails|\Dojo_PHP\Model\ProblemDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function refundsCreateWithHttpInfo($version, $payment_intent_id, $idempotency_key, $create_refund_request, string $contentType = self::contentTypes['refundsCreate'][0])
    {
        $request = $this->refundsCreateRequest($version, $payment_intent_id, $idempotency_key, $create_refund_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundsCreateAsync($version, $payment_intent_id, $idempotency_key, $create_refund_request, string $contentType = self::contentTypes['refundsCreate'][0])
    {
        return $this->refundsCreateAsyncWithHttpInfo($version, $payment_intent_id, $idempotency_key, $create_refund_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundsCreateAsyncWithHttpInfo($version, $payment_intent_id, $idempotency_key, $create_refund_request, string $contentType = self::contentTypes['refundsCreate'][0])
    {
        $returnType = '\Dojo_PHP\Model\Refund';
        $request = $this->refundsCreateRequest($version, $payment_intent_id, $idempotency_key, $create_refund_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function refundsCreateRequest($version, $payment_intent_id, $idempotency_key, $create_refund_request, string $contentType = self::contentTypes['refundsCreate'][0])
    {

        // verify the required parameter 'version' is set
        if ($version === null || (is_array($version) && count($version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $version when calling refundsCreate'
            );
        }
        ...
        if ($payment_intent_id === null || (is_array($payment_intent_id) && count($payment_intent_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_intent_id when calling refundsCreate'
            );
        }
        ...
        if ($idempotency_key === null || (is_array($idempotency_key) && count($idempotency_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $idempotency_key when calling refundsCreate'
            );
        }
        if (strlen($idempotency_key) > 100) {
            throw new \InvalidArgumentException('invalid length for "$idempotency_key" when calling RefundsApi.refundsCreate, must be smaller than or equal to 100.');
        }
        ...
        if ($create_refund_request === null || (is_array($create_refund_request) && count($create_refund_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_refund_request when calling refundsCreate'
            );
        }


        $resourcePath = '/payment-intents/{paymentIntentId}/refunds';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($idempotency_key !== null) {
            $headerParams['idempotencyKey'] = ObjectSerializer::toHeaderValue($idempotency_key);
        }
