...
/**
     ...
     * @param  \DateTime $version API version with format yyyy-mm-dd. Current version is 2022–04–07. Today&#39;s date will always give you the latest version. (required)
     * @param  string $payment_intent_id Unique identifier for the payment intent. (required)
     * @param  \Dojo_PHP\Model\SendEmailReceiptRequest $send_email_receipt_request  (optional)
     ...
     * @return void
     */
    public function receiptCreate($version, $payment_intent_id, $send_email_receipt_request = null, string $contentType = self::contentTypes['receiptCreate'][0])
    {
     ...
     */
    public function receiptCreateWithHttpInfo($version, $payment_intent_id, $send_email_receipt_request = null, string $contentType = self::contentTypes['receiptCreate'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptCreateAsync($version, $payment_intent_id, $send_email_receipt_request = null, string $contentType = self::contentTypes['receiptCreate'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptCreateAsyncWithHttpInfo($version, $payment_intent_id, $send_email_receipt_request = null, string $contentType = self::contentTypes['receiptCreate'][0])
    {
        $returnType = '';
        $request = $this->receiptCreateRequest($version, $payment_intent_id, $send_email_receipt_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function receiptCreateRequest($version, $payment_intent_id, $send_email_receipt_request = null, string $contentType = self::contentTypes['receiptCreate'][0])
    {
