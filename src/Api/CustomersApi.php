...
class CustomersApi
{
     ...
     * Create a customer
     *
     * @param  string $version The API version with format yyyy-mm-dd. The current version is &#x60;2025-09-10&#x60;. (required)
     ...
     * @param  string $version The API version with format yyyy-mm-dd. The current version is &#x60;2025-09-10&#x60;. (required)
     * @param  string $authorization Basic HTTP authentication to grant access to customer-owned resources.  - The required customer secret key is short-lived and will expire after a pre-configured set of time. - The customer secret can be generated by calling [POST /customers/{&#x60;customerId&#x60;}/create-secret](#operation/Customers_CreateCustomerSecret) (required)
    ...
    public function customersGetRequest($customer_id, $version, string $contentType = self::contentTypes['customersGet'][0])
    {
        ...
        if (strlen($customer_id) > 100) {
            throw new \InvalidArgumentException('invalid length for "$customer_id" when calling CustomersApi.customersGet, must be smaller than or equal to 100.');
        }
    ...
    public function customersUpdateRequest($customer_id, $version, $update_customer_request, string $contentType = self::contentTypes['customersUpdate'][0])
    {
        ...
        if (strlen($customer_id) > 100) {
            throw new \InvalidArgumentException('invalid length for "$customer_id" when calling CustomersApi.customersUpdate, must be smaller than or equal to 100.');
        }
