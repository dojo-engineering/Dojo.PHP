...
class TaxLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('affected_plu', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['affected_plu']) && (mb_strlen($this->container['affected_plu']) > 200)) {
            $invalidProperties[] = "invalid value for 'affected_plu', the character length must be smaller than or equal to 200.";
        }
     ...
     * @return string|null
     */
    public function getAffectedPlu()
    {
        return $this->container['affected_plu'];
    }

    /**
     * Sets affected_plu
     *
     * @param string|null $affected_plu The affected price look-up code of the tax.
     *
     * @return self
     */
    public function setAffectedPlu($affected_plu)
    {
        if (is_null($affected_plu)) {
            throw new \InvalidArgumentException('non-nullable affected_plu cannot be null');
        }
        if ((mb_strlen($affected_plu) > 200)) {
            throw new \InvalidArgumentException('invalid length for $affected_plu when calling TaxLine., must be smaller than or equal to 200.');
        }

        $this->container['affected_plu'] = $affected_plu;
