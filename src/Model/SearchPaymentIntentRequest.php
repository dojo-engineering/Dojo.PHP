...
/**
 * SearchPaymentIntentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SearchPaymentIntentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchPaymentIntentRequest';
    ...
    protected static $openAPITypes = [
        'statuses' => '\Dojo_PHP\Model\PaymentIntentStatus[]',
        'start_date' => '\DateTime',
        'end_date' => '\DateTime',
        'cursor' => '\Dojo_PHP\Model\SearchPaymentIntentRequestCursor'
    ];
    ...
    */
     ...
     * Sets statuses
     *
     * @param \Dojo_PHP\Model\PaymentIntentStatus[]|null $statuses Statuses of requested payment intents.
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date Date and time from which to search, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) UTC format.
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date Date and time until which to search in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) UTC format.
     *
     * @return self
     */
     ...
     * Gets cursor
     *
     * @return \Dojo_PHP\Model\SearchPaymentIntentRequestCursor|null
     */
     ...
     * Sets cursor
     *
     * @param \Dojo_PHP\Model\SearchPaymentIntentRequestCursor|null $cursor cursor
     *
     * @return self
     */
