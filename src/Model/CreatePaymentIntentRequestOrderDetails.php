<?php
/**
 * CreatePaymentIntentRequestOrderDetails
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreatePaymentIntentRequestOrderDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePaymentIntentRequestOrderDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentIntentRequest_orderDetails';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_update', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \DateTime|null $availability_date The payment description.
     *
     * @return self
     */
     ...
     * Sets is_update
     *
     * @param bool|null $is_update An optional true/false field.
     *
     * @return self
     */
    public function setIsUpdate($is_update)
    {
        if (is_null($is_update)) {
            array_push($this->openAPINullablesSetToNull, 'is_update');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_update', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the order in Dojo.
     *
     * @return self
     */
     ...
     * Sets external_id
     *
     * @param string|null $external_id The unique identifier of the order in external systems, such as EPOS.
     *
     * @return self
     */
