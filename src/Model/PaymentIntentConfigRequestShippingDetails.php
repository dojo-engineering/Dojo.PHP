<?php
/**
 * PaymentIntentConfigRequestShippingDetails
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PaymentIntentConfigRequestShippingDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentIntentConfigRequestShippingDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentIntentConfigRequest_shippingDetails';
    ...
    {
        $this->setIfExists('collection_required', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $collection_required Set to `true` if the object requires collection.
     *
     * @return self
     */
