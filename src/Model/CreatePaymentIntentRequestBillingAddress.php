<?php
/**
 * CreatePaymentIntentRequestBillingAddress
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreatePaymentIntentRequestBillingAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePaymentIntentRequestBillingAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentIntentRequest_billingAddress';
    ...
    */
    ...
    public function setAddress1($address1)
    {
        ...
        if (!is_null($address1) && (mb_strlen($address1) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling CreatePaymentIntentRequestBillingAddress., must be smaller than or equal to 100.');
        }
    ...
    public function setAddress2($address2)
    {
        ...
        if (!is_null($address2) && (mb_strlen($address2) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling CreatePaymentIntentRequestBillingAddress., must be smaller than or equal to 100.');
        }
    ...
    public function setAddress3($address3)
    {
        ...
        if (!is_null($address3) && (mb_strlen($address3) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address3 when calling CreatePaymentIntentRequestBillingAddress., must be smaller than or equal to 100.');
        }
    ...
    public function setAddress4($address4)
    {
        ...
        if (!is_null($address4) && (mb_strlen($address4) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address4 when calling CreatePaymentIntentRequestBillingAddress., must be smaller than or equal to 100.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $city when calling CreatePaymentIntentRequestBillingAddress., must be smaller than or equal to 100.');
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) > 100)) {
            throw new \InvalidArgumentException('invalid length for $state when calling CreatePaymentIntentRequestBillingAddress., must be smaller than or equal to 100.');
        }
    ...
    public function setPostcode($postcode)
    {
        ...
        if (!is_null($postcode) && (mb_strlen($postcode) > 50)) {
            throw new \InvalidArgumentException('invalid length for $postcode when calling CreatePaymentIntentRequestBillingAddress., must be smaller than or equal to 50.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreatePaymentIntentRequestBillingAddress., must be smaller than or equal to 10.');
        }
    ...
    public function setLocality($locality)
    {
        ...
        if (!is_null($locality) && (mb_strlen($locality) > 100)) {
            throw new \InvalidArgumentException('invalid length for $locality when calling CreatePaymentIntentRequestBillingAddress., must be smaller than or equal to 100.');
        }
    ...
    public function setCounty($county)
    {
        ...
        if (!is_null($county) && (mb_strlen($county) > 100)) {
            throw new \InvalidArgumentException('invalid length for $county when calling CreatePaymentIntentRequestBillingAddress., must be smaller than or equal to 100.');
        }
