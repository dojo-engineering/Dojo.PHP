...
/**
 * CaptureDetails Class Doc Comment
 *
 * @category Class
 * @package  Dojo_PHP
 * @author   OpenAPI Generator team
 ...
 */
class CaptureDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CaptureDetails';
    ...
    protected static $openAPITypes = [
        ...
        'amount' => 'int',
        'tips_amount' => 'int',
        'status' => '\Dojo_PHP\Model\CaptureStatus',
        'created_at' => '\DateTime'
    ];
    ...
    */
     ...
     * Sets tips_amount
     *
     * @param int|null $tips_amount tips_amount
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \Dojo_PHP\Model\CaptureStatus|null
     */
     ...
     * Sets status
     *
     * @param \Dojo_PHP\Model\CaptureStatus|null $status status
     *
     * @return self
     */
