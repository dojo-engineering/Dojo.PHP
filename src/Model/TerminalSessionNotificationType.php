...
/**
 * TerminalSessionNotificationType Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Dojo_PHP
 ...
 * @link     https://openapi-generator.tech
 */
class TerminalSessionNotificationType
{
    /**
    ...
    public const INSERT_CARD = 'InsertCard';

    public const ENTER_PIN = 'EnterPin';

    public const PLEASE_WAIT = 'PleaseWait';

    public const PRESENT_CARD = 'PresentCard';

    public const PRESENT_ONLY_ONE_CARD = 'PresentOnlyOneCard';

    public const REMOVE_CARD = 'RemoveCard';

    public const CARD_UNSUPPORTED = 'CardUnsupported';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::PLEASE_WAIT,
            self::PRESENT_CARD,
            self::PRESENT_ONLY_ONE_CARD,
            self::REMOVE_CARD,
            self::CARD_UNSUPPORTED
        ];
    }
}
