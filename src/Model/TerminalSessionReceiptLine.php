...
/**
 * TerminalSessionReceiptLine Class Doc Comment
 *
 * @category Class
 ...
 */
class TerminalSessionReceiptLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TerminalSessionReceiptLine';
    ...
    protected static $openAPITypes = [
        'line_type' => '\Dojo_PHP\Model\TerminalSessionReceiptLineType',
        'text' => '\Dojo_PHP\Model\TerminalSessionReceiptText',
        'image_logo' => '\Dojo_PHP\Model\TerminalSessionReceiptImageLogo'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('image_logo', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets line_type
     *
     * @return \Dojo_PHP\Model\TerminalSessionReceiptLineType
     */
     ...
     * Sets line_type
     *
     * @param \Dojo_PHP\Model\TerminalSessionReceiptLineType $line_type line_type
     *
     * @return self
     */
     ...
     * Gets text
     *
     * @return \Dojo_PHP\Model\TerminalSessionReceiptText|null
     */
     ...
     * Sets text
     *
     * @param \Dojo_PHP\Model\TerminalSessionReceiptText|null $text text
     *
     * @return self
     */
     ...
     * Gets image_logo
     *
     * @return \Dojo_PHP\Model\TerminalSessionReceiptImageLogo|null
     */
    public function getImageLogo()
    {
        return $this->container['image_logo'];
    }

    /**
     * Sets image_logo
     *
     * @param \Dojo_PHP\Model\TerminalSessionReceiptImageLogo|null $image_logo image_logo
     *
     * @return self
     */
    public function setImageLogo($image_logo)
    {
        if (is_null($image_logo)) {
            throw new \InvalidArgumentException('non-nullable image_logo cannot be null');
        }
        $this->container['image_logo'] = $image_logo;
