<?php
/**
 * SearchPaymentIntentRequestCursor
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SearchPaymentIntentRequestCursor Class Doc Comment
 *
 * @category Class
 ...
 */
class SearchPaymentIntentRequestCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchPaymentIntentRequest_cursor';
    ...
    */
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 100)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchPaymentIntentRequestCursor., must be smaller than or equal to 100.');
        }
        if (($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchPaymentIntentRequestCursor., must be bigger than or equal to 1.');
        }
