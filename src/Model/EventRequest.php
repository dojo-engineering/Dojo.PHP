 ...
 */
class EventRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventRequest';
    ...
    protected static $openAPITypes = [
        'event_type' => 'string',
        'event' => '\Dojo_PHP\Model\EventRequestEvent'
    ];
    ...
    */
     ...
     * Sets event_type
     *
     * @param string $event_type OrderUpdated, PartyUpdated, ReservationUpdated
     *
     * @return self
     */
     ...
     * Gets event
     *
     * @return \Dojo_PHP\Model\EventRequestEvent
     */
     ...
     * Sets event
     *
     * @param \Dojo_PHP\Model\EventRequestEvent $event event
     *
     * @return self
     */
