...
class CreatePaymentIntentRequestShippingDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['delivery_notes']) && (mb_strlen($this->container['delivery_notes']) > 1024)) {
            $invalidProperties[] = "invalid value for 'delivery_notes', the character length must be smaller than or equal to 1024.";
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreatePaymentIntentRequestShippingDetails., must be smaller than or equal to 100.');
        }
    ...
    public function setDeliveryNotes($delivery_notes)
    {
        ...
        if (!is_null($delivery_notes) && (mb_strlen($delivery_notes) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $delivery_notes when calling CreatePaymentIntentRequestShippingDetails., must be smaller than or equal to 1024.');
        }
