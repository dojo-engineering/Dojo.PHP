...
/**
 * CustomerSecret Class Doc Comment
 *
 * @category Class
 * @package  Dojo_PHP
 * @author   OpenAPI Generator team
 ...
 */
class CustomerSecret implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerSecret';
    ...
    */
     ...
     * Sets secret
     *
     * @param string|null $secret The unique identifier for the secret.
     *
     * @return self
     */
     ...
     * Sets expire_at
     *
     * @param \DateTime|null $expire_at The timestamp at which the customer secret expires, in [ISO 8601]((https://en.wikipedia.org/wiki/ISO_8601) UTC format.
     *
     * @return self
     */
