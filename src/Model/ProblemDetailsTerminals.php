...
/**
 * ProblemDetailsTerminals Class Doc Comment
 *
 * @category Class
 ...
 */
class ProblemDetailsTerminals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProblemDetailsTerminals';
    ...
    */
     ...
     * Sets detail
     *
     * @param string $detail An optional, human-readable message giving more details about the error.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param array<string,mixed> $errors A human-readable explanation of errors.
     *
     * @return self
     */
