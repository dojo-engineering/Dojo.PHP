...
/**
 * RestIntegrationResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class RestIntegrationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestIntegrationResponse';
    ...
    protected static $openAPITypes = [
        'url' => 'string',
        'capabilities' => '\Dojo_PHP\Model\CapabilityResponse[]',
        'auth' => '\Dojo_PHP\Model\RestAuthResponse',
        'created_at' => '\DateTime'
    ];
    ...
    */
     ...
     * Gets capabilities
     *
     * @return \Dojo_PHP\Model\CapabilityResponse[]
     */
     ...
     * Sets capabilities
     *
     * @param \Dojo_PHP\Model\CapabilityResponse[] $capabilities Receive a response to a REST request
     *
     * @return self
     */
     ...
     * Gets auth
     *
     * @return \Dojo_PHP\Model\RestAuthResponse
     */
     ...
     * Sets auth
     *
     * @param \Dojo_PHP\Model\RestAuthResponse $auth auth
     *
     * @return self
     */
