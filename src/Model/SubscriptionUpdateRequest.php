...
class SubscriptionUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionUpdateRequest';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if (!is_null($url) && (!preg_match("/^https:\/\/_*.+/", ObjectSerializer::toString($url)))) {
            throw new \InvalidArgumentException("invalid value for \$url when calling SubscriptionUpdateRequest., must conform to the pattern /^https:\/\/_*.+/.");
        }
