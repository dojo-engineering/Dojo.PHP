...
/**
 * TerminalSessionUnlinkedRefundDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class TerminalSessionUnlinkedRefundDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TerminalSessionUnlinkedRefundDetails';
    ...
    protected static $attributeMap = [
        'amount' => 'amount',
        'cardholder_not_present' => 'cardholderNotPresent'
    ];
    ...
    protected static $setters = [
        'amount' => 'setAmount',
        'cardholder_not_present' => 'setCardholderNotPresent'
    ];
    ...
    protected static $getters = [
        'amount' => 'getAmount',
        'cardholder_not_present' => 'getCardholderNotPresent'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cardholder_not_present', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets cardholder_not_present
     *
     * @return bool|null
     */
    public function getCardholderNotPresent()
    {
        return $this->container['cardholder_not_present'];
    }

    /**
     * Sets cardholder_not_present
     *
     * @param bool|null $cardholder_not_present Indicates whether this transaction should be completed as Cardholder Not Present (CNP), with manual entry of card details. If the flag is true, the card machine skips the `Present Card` screen and goes directly into Key Card Number.
     *
     * @return self
     */
    public function setCardholderNotPresent($cardholder_not_present)
    {
        if (is_null($cardholder_not_present)) {
            throw new \InvalidArgumentException('non-nullable cardholder_not_present cannot be null');
        }
        $this->container['cardholder_not_present'] = $cardholder_not_present;
