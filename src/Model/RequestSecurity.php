...
/**
 * RequestSecurity Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestSecurity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestSecurity';
    ...
    */
    ...
    public function setUserAgent($user_agent)
    {
        ...
        if (!is_null($user_agent) && (mb_strlen($user_agent) > 300)) {
            throw new \InvalidArgumentException('invalid length for $user_agent when calling RequestSecurity., must be smaller than or equal to 300.');
        }
    ...
    public function setIpAddress($ip_address)
    {
        ...
        if (!is_null($ip_address) && (mb_strlen($ip_address) > 70)) {
            throw new \InvalidArgumentException('invalid length for $ip_address when calling RequestSecurity., must be smaller than or equal to 70.');
        }
    ...
    public function setDevice($device)
    {
        ...
        if (!is_null($device) && (mb_strlen($device) > 120)) {
            throw new \InvalidArgumentException('invalid length for $device when calling RequestSecurity., must be smaller than or equal to 120.');
        }
