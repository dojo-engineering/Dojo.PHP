 ...
 */
class ActionLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionLink';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling ActionLink., must be bigger than or equal to 1.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 60)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ActionLink., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ActionLink., must be bigger than or equal to 1.');
        }
    ...
    public function setFileName($file_name)
    {
        ...
        if (!is_null($file_name) && (mb_strlen($file_name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling ActionLink., must be smaller than or equal to 256.');
        }
