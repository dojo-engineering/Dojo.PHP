...
class Cursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 100)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling Cursor., must be smaller than or equal to 100.');
        }
        if (($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling Cursor., must be bigger than or equal to 1.');
        }
