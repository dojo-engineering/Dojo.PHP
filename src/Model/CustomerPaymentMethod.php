 ...
 */
class CustomerPaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'card_details' => '\Dojo_PHP\Model\CustomerPaymentMethodCardDetails'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the customer's saved payment method.
     *
     * @return self
     */
     ...
     * Gets card_details
     *
     * @return \Dojo_PHP\Model\CustomerPaymentMethodCardDetails|null
     */
     ...
     * Sets card_details
     *
     * @param \Dojo_PHP\Model\CustomerPaymentMethodCardDetails|null $card_details card_details
     *
     * @return self
     */
    public function setCardDetails($card_details)
    {
        if (is_null($card_details)) {
            array_push($this->openAPINullablesSetToNull, 'card_details');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('card_details', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
