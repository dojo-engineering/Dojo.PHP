<?php
/**
 * CreatePaymentIntentRequestRequestSecurity
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreatePaymentIntentRequestRequestSecurity Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePaymentIntentRequestRequestSecurity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentIntentRequest_requestSecurity';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['user_agent']) && (mb_strlen($this->container['user_agent']) > 300)) {
            $invalidProperties[] = "invalid value for 'user_agent', the character length must be smaller than or equal to 300.";
        }

        if (!is_null($this->container['ip_address']) && (mb_strlen($this->container['ip_address']) > 70)) {
            $invalidProperties[] = "invalid value for 'ip_address', the character length must be smaller than or equal to 70.";
        }

        if (!is_null($this->container['device']) && (mb_strlen($this->container['device']) > 120)) {
            $invalidProperties[] = "invalid value for 'device', the character length must be smaller than or equal to 120.";
        }
     ...
     * Sets user_agent
     *
     * @param string|null $user_agent The customer's browser agent.
     *
     * @return self
     */
    public function setUserAgent($user_agent)
    {
        ...
        if (!is_null($user_agent) && (mb_strlen($user_agent) > 300)) {
            throw new \InvalidArgumentException('invalid length for $user_agent when calling CreatePaymentIntentRequestRequestSecurity., must be smaller than or equal to 300.');
        }
     ...
     * Sets ip_address
     *
     * @param string|null $ip_address The customer's device IP address.
     *
     * @return self
     */
    public function setIpAddress($ip_address)
    {
        ...
        if (!is_null($ip_address) && (mb_strlen($ip_address) > 70)) {
            throw new \InvalidArgumentException('invalid length for $ip_address when calling CreatePaymentIntentRequestRequestSecurity., must be smaller than or equal to 70.');
        }
     ...
     * Sets device
     *
     * @param string|null $device The customer's device type.
     *
     * @return self
     */
    public function setDevice($device)
    {
        ...
        if (!is_null($device) && (mb_strlen($device) > 120)) {
            throw new \InvalidArgumentException('invalid length for $device when calling CreatePaymentIntentRequestRequestSecurity., must be smaller than or equal to 120.');
        }
