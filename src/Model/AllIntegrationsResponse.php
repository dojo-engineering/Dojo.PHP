...
/**
 * AllIntegrationsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class AllIntegrationsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AllIntegrationsResponse';
    ...
    protected static $openAPITypes = [
        'ws_integrations' => '\Dojo_PHP\Model\WsIntegrationResponse[]',
        'rest_integrations' => '\Dojo_PHP\Model\RestIntegrationResponse[]',
        'dojo_managed_integrations' => '\Dojo_PHP\Model\DojoManagedIntegrationResponse[]'
    ];
    ...
    protected static $openAPIFormats = [
        'ws_integrations' => null,
        'rest_integrations' => null,
        'dojo_managed_integrations' => null
    ];
    ...
    protected static array $openAPINullables = [
        'ws_integrations' => false,
        'rest_integrations' => false,
        'dojo_managed_integrations' => false
    ];
    ...
    protected static $attributeMap = [
        'ws_integrations' => 'wsIntegrations',
        'rest_integrations' => 'restIntegrations',
        'dojo_managed_integrations' => 'dojoManagedIntegrations'
    ];
    ...
    protected static $setters = [
        'ws_integrations' => 'setWsIntegrations',
        'rest_integrations' => 'setRestIntegrations',
        'dojo_managed_integrations' => 'setDojoManagedIntegrations'
    ];
    ...
    protected static $getters = [
        'ws_integrations' => 'getWsIntegrations',
        'rest_integrations' => 'getRestIntegrations',
        'dojo_managed_integrations' => 'getDojoManagedIntegrations'
    ];
    ...
    {
        $this->setIfExists('ws_integrations', $data ?? [], null);
        $this->setIfExists('rest_integrations', $data ?? [], null);
        $this->setIfExists('dojo_managed_integrations', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ws_integrations'] === null) {
            $invalidProperties[] = "'ws_integrations' can't be null";
        }
        if ($this->container['rest_integrations'] === null) {
            $invalidProperties[] = "'rest_integrations' can't be null";
        }
    ...
    /**
     * Gets ws_integrations
     *
     * @return \Dojo_PHP\Model\WsIntegrationResponse[]
     */
    public function getWsIntegrations()
    {
        return $this->container['ws_integrations'];
    }

    /**
     * Sets ws_integrations
     *
     * @param \Dojo_PHP\Model\WsIntegrationResponse[] $ws_integrations All the WS integrations currently registered and active for this account.
     *
     * @return self
     */
    public function setWsIntegrations($ws_integrations)
    {
        if (is_null($ws_integrations)) {
            throw new \InvalidArgumentException('non-nullable ws_integrations cannot be null');
        }
        $this->container['ws_integrations'] = $ws_integrations;

        return $this;
    }

    /**
     * Gets rest_integrations
     *
     * @return \Dojo_PHP\Model\RestIntegrationResponse[]
     */
    public function getRestIntegrations()
    {
        return $this->container['rest_integrations'];
    }

    /**
     * Sets rest_integrations
     *
     * @param \Dojo_PHP\Model\RestIntegrationResponse[] $rest_integrations All the WS integrations currently registered and active for this account.
     *
     * @return self
     */
    public function setRestIntegrations($rest_integrations)
    {
        if (is_null($rest_integrations)) {
            throw new \InvalidArgumentException('non-nullable rest_integrations cannot be null');
        }
        $this->container['rest_integrations'] = $rest_integrations;

        return $this;
    }

    /**
     * Gets dojo_managed_integrations
     *
     * @return \Dojo_PHP\Model\DojoManagedIntegrationResponse[]|null
     */
    public function getDojoManagedIntegrations()
    {
        return $this->container['dojo_managed_integrations'];
    }

    /**
     * Sets dojo_managed_integrations
     *
     * @param \Dojo_PHP\Model\DojoManagedIntegrationResponse[]|null $dojo_managed_integrations All the integrations managed by Dojo
     *
     * @return self
     */
    public function setDojoManagedIntegrations($dojo_managed_integrations)
    {
        if (is_null($dojo_managed_integrations)) {
            throw new \InvalidArgumentException('non-nullable dojo_managed_integrations cannot be null');
        }
        $this->container['dojo_managed_integrations'] = $dojo_managed_integrations;
