...
/**
 * PaymentIntentRefundedAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentIntentRefundedAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentIntent_refundedAmount';
    ...
    */
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling PaymentIntentRefundedAmount., must be bigger than or equal to 1.');
        }
