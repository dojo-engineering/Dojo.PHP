...
/**
 * SetTipsAmountRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SetTipsAmountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetTipsAmountRequest';
    ...
    protected static $openAPITypes = [
        'tips_amount' => '\Dojo_PHP\Model\SetTipsAmountRequestTipsAmount'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tips_amount'] === null) {
            $invalidProperties[] = "'tips_amount' can't be null";
        }
     ...
     * Gets tips_amount
     *
     * @return \Dojo_PHP\Model\SetTipsAmountRequestTipsAmount
     */
     ...
     * Sets tips_amount
     *
     * @param \Dojo_PHP\Model\SetTipsAmountRequestTipsAmount $tips_amount tips_amount
     *
     * @return self
     */
    public function setTipsAmount($tips_amount)
    {
        if (is_null($tips_amount)) {
            throw new \InvalidArgumentException('non-nullable tips_amount cannot be null');
        }
