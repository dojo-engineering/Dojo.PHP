...
/**
 * ItemLineAmountTotal Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemLineAmountTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemLine_amountTotal';
    ...
    */
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling ItemLineAmountTotal., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($currency_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling ItemLineAmountTotal., must be bigger than or equal to 1.');
        }
