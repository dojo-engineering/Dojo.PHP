...
/**
 * RestAuthResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class RestAuthResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestAuthResponse';
    ...
    protected static $openAPITypes = [
        'auth_type' => 'string',
        'basic' => '\Dojo_PHP\Model\RestBasicAuthResponse'
    ];
    ...
    */
     ...
     * Sets auth_type
     *
     * @param string $auth_type The authentication flow that Dojo will use to make requests against this REST integration.
     *
     * @return self
     */
     ...
     * Gets basic
     *
     * @return \Dojo_PHP\Model\RestBasicAuthResponse|null
     */
     ...
     * Sets basic
     *
     * @param \Dojo_PHP\Model\RestBasicAuthResponse|null $basic basic
     *
     * @return self
     */
