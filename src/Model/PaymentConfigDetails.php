...
class PaymentConfigDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool|null $custom_amount_allowed If set to `true` the amount of the payment intent can be changed.
     *
     * @return self
     */
     ...
     * Sets tips_allowed
     *
     * @param bool|null $tips_allowed If set to `true`, tip is allowed.
     *
     * @return self
     */
