<?php
/**
 * MerchantConfigSupportedPaymentMethods
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * MerchantConfigSupportedPaymentMethods Class Doc Comment
 *
 * @category Class
 ...
 */
class MerchantConfigSupportedPaymentMethods implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantConfig_supportedPaymentMethods';
    ...
    protected static $openAPITypes = [
        'card_schemes' => '\Dojo_PHP\Model\CardScheme[]',
        'wallets' => '\Dojo_PHP\Model\WalletPaymentOption[]'
    ];
    ...
    */
     ...
     * Gets card_schemes
     *
     * @return \Dojo_PHP\Model\CardScheme[]|null
     */
     ...
     * Sets card_schemes
     *
     * @param \Dojo_PHP\Model\CardScheme[]|null $card_schemes Supported card schemes.
     *
     * @return self
     */
    public function setCardSchemes($card_schemes)
    {
        if (is_null($card_schemes)) {
            array_push($this->openAPINullablesSetToNull, 'card_schemes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('card_schemes', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets wallets
     *
     * @return \Dojo_PHP\Model\WalletPaymentOption[]|null
     */
     ...
     * Sets wallets
     *
     * @param \Dojo_PHP\Model\WalletPaymentOption[]|null $wallets List of supported payment wallets.
     *
     * @return self
     */
    ...
    {
        if (is_null($wallets)) {
            array_push($this->openAPINullablesSetToNull, 'wallets');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('wallets', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
