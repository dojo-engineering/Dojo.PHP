...
class SearchCustomerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['before']) && (mb_strlen($this->container['before']) > 200)) {
            $invalidProperties[] = "invalid value for 'before', the character length must be smaller than or equal to 200.";
        }

        if (!is_null($this->container['after']) && (mb_strlen($this->container['after']) > 200)) {
            $invalidProperties[] = "invalid value for 'after', the character length must be smaller than or equal to 200.";
        }
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 100)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchCustomerRequest., must be smaller than or equal to 100.');
        }
        if (($limit < 1)) {
    ...
    public function setBefore($before)
    {
        ...
        if (!is_null($before) && (mb_strlen($before) > 200)) {
            throw new \InvalidArgumentException('invalid length for $before when calling SearchCustomerRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setAfter($after)
    {
        ...
        if (!is_null($after) && (mb_strlen($after) > 200)) {
            throw new \InvalidArgumentException('invalid length for $after when calling SearchCustomerRequest., must be smaller than or equal to 200.');
        }
