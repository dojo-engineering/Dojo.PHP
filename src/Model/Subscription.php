...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier for the subscription.
     *
     * @return self
     */
     ...
     * Sets secrets
     *
     * @param \Dojo_PHP\Model\SubscriptionSecret[]|null $secrets The list of secrets associated with the subscription. Used to generate signatures.
     *
     * @return self
     */
