...
class CreateReversalRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets reason
     *
     * @param string|null $reason The cause of this reversal.
     *
     * @return self
     */
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) > 128)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling CreateReversalRequest., must be smaller than or equal to 128.');
        }
