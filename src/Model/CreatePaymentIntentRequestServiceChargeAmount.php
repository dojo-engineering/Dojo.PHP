<?php
/**
 * CreatePaymentIntentRequestServiceChargeAmount
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreatePaymentIntentRequestServiceChargeAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePaymentIntentRequestServiceChargeAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentIntentRequest_serviceChargeAmount';
    ...
    */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Three-letter currency code in [ISO 4217 alpha-3](https://en.wikipedia.org/wiki/ISO_4217) format. Currently accepting `GBP` and `EUR`.
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CreatePaymentIntentRequestServiceChargeAmount., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($currency_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CreatePaymentIntentRequestServiceChargeAmount., must be bigger than or equal to 1.');
        }
