 ...
 */
class Reversal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Reversal';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('reversal_id', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['reversal_id'];
    }

    /**
     * Sets reversal_id
     *
     * @param string|null $reversal_id The unique identifier for the reversal.
     *
     * @return self
     */
    public function setReversalId($reversal_id)
    {
        if (is_null($reversal_id)) {
            array_push($this->openAPINullablesSetToNull, 'reversal_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reversal_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['reversal_id'] = $reversal_id;
