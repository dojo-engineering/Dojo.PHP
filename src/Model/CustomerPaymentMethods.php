...
class CustomerPaymentMethods implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string|null $customer_id The unique identifier of the customer.
     *
     * @return self
     */
     ...
     * Sets merchant_id
     *
     * @param string|null $merchant_id A unique identifier for the merchant. A single merchant can be associated with multiple terminals, point-of-sale machines, and waiters.
     *
     * @return self
     */
