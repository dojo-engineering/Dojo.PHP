...
class CustomerFull implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerFull';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('document_version', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $document_version The version of the customer's data, updated with every change.
     *
     * @return self
     */
    public function setDocumentVersion($document_version)
    {
        if (is_null($document_version)) {
            throw new \InvalidArgumentException('non-nullable document_version cannot be null');
        }
