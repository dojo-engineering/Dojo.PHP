...
/**
 * TerminalSessionStatusEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class TerminalSessionStatusEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TerminalSessionStatusEvent';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('debug_message', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['debug_message'] === null) {
            $invalidProperties[] = "'debug_message' can't be null";
        }
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The timestamp of the create date, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) UTC format.
     *
     * @return self
     */
    ...
    {
        return $this->container['debug_message'];
    }

    /**
     * Sets debug_message
     *
     * @param string $debug_message The message to troubleshoot the terminal session by revealing the internal state of the terminal.
     *
     * @return self
     */
    public function setDebugMessage($debug_message)
    {
        if (is_null($debug_message)) {
            throw new \InvalidArgumentException('non-nullable debug_message cannot be null');
        }
        $this->container['debug_message'] = $debug_message;
