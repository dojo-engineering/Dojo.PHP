...
class TerminalSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'receipt' => '\Dojo_PHP\Model\TerminalSessionReceipt',
    ...
    */
     ...
     * Sets expire_at
     *
     * @param \DateTime $expire_at The timestamp and date of when a terminal session will be marked as `Expired`, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) UTC format. This changes throughout the life cycle of a terminal session as it moves to different states.
     *
     * @return self
     */
     ...
     * Sets receipt
     *
     * @param \Dojo_PHP\Model\TerminalSessionReceipt|null $receipt receipt
     *
     * @return self
     */
