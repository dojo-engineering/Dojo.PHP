...
/**
 * EventRequestEvent Class Doc Comment
 *
 * @category Class
 * @package  Dojo_PHP
 * @author   OpenAPI Generator team
 ...
 */
class EventRequestEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventRequest_event';
    ...
    */
     ...
     * Sets party_id
     *
     * @param string $party_id The EPOS-internal ID of the updated Party.
     *
     * @return self
     */
     ...
     * Sets reservation_id
     *
     * @param string $reservation_id The EPOS-internal ID of the updated Reservation.
     *
     * @return self
     */
