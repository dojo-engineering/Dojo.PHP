...
class CreatePaymentIntentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets reference
     *
     * @param string $reference A unique identifier of the payment. For example, `Order 236`.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $generate_remote_token Set to `true` for accepting online payments immediately. Defaults to `false`.
     *
     * @return self
     */
