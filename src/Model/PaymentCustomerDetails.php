...
/**
 * PaymentCustomerDetails Class Doc Comment
 *
 * @category Class
 * @package  Dojo_PHP
 * @author   OpenAPI Generator team
 ...
 */
class PaymentCustomerDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentCustomerDetails';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('saved_card_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if (!is_null($email_address) && (mb_strlen($email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling PaymentCustomerDetails., must be smaller than or equal to 254.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling PaymentCustomerDetails., must be smaller than or equal to 50.');
        }
     ...
     * Sets secret
     *
     * @param string|null $secret The customer secret value.
     *
     * @return self
     */
     ...
     * Sets saved_card_id
     *
     * @param string|null $saved_card_id The unique ID of the customer's saved card.
     *
     * @return self
     */
    public function setSavedCardId($saved_card_id)
    {
        if (is_null($saved_card_id)) {
            array_push($this->openAPINullablesSetToNull, 'saved_card_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('saved_card_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
