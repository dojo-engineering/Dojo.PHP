...
/**
 * PaymentIntentTotalAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentIntentTotalAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentIntent_totalAmount';
    ...
    */
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling PaymentIntentTotalAmount., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($currency_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling PaymentIntentTotalAmount., must be bigger than or equal to 1.');
        }
