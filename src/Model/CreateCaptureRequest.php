...
/**
 * CreateCaptureRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateCaptureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCaptureRequest';
    ...
    */
     ...
     * Sets amount
     *
     * @param int $amount The capture amount. You can capture a full or partial amount. Multiple partial captures can be made on the same total.
     *
     * @return self
     */
     ...
     * Sets tips_amount
     *
     * @param int|null $tips_amount The tip amount.
     *
     * @return self
     */
