...
/**
 * TerminalSessionType Class Doc Comment
 *
 * @category Class
...
class TerminalSessionType
{
    ...
    public const MATCHED_REFUND = 'MatchedRefund';

    public const UNLINKED_REFUND = 'UnlinkedRefund';
