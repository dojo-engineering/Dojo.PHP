 ...
 *
 * @category Class
 * @description The amount intended to be collected by this payment intent excluding &#x60;tipsAmount&#x60; and &#x60;cashbackAmount&#x60;.
 * @package  Dojo_PHP
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling Money., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($currency_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling Money., must be bigger than or equal to 1.');
        }
