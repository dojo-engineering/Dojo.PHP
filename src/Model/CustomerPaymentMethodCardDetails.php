<?php
/**
 * CustomerPaymentMethodCardDetails
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CustomerPaymentMethodCardDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerPaymentMethodCardDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerPaymentMethod_cardDetails';
    ...
    protected static $openAPITypes = [
        'pan' => 'string',
        'expiry_date' => 'string',
        'scheme' => '\Dojo_PHP\Model\CardScheme'
    ];
    ...
    */
     ...
     * Sets pan
     *
     * @param string|null $pan The masked pan number of the card saved by the customer.
     *
     * @return self
     */
    ...
    {
        if (is_null($pan)) {
            array_push($this->openAPINullablesSetToNull, 'pan');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pan', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets expiry_date
     *
     * @param string|null $expiry_date The expiry date of the card saved by the customer.
     *
     * @return self
     */
     ...
     * Sets scheme
     *
     * @param \Dojo_PHP\Model\CardScheme|null $scheme scheme
     *
     * @return self
     */
