<?php
/**
 * CreatePaymentIntentRequestAmount
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreatePaymentIntentRequestAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePaymentIntentRequestAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentIntentRequest_amount';
    ...
    */
    ...
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CreatePaymentIntentRequestAmount., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($currency_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CreatePaymentIntentRequestAmount., must be bigger than or equal to 1.');
        }
