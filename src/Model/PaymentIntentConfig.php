...
/**
 * PaymentIntentConfig Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentIntentConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentIntent_config';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $title when calling PaymentIntentConfig., must be smaller than or equal to 100.');
        }
