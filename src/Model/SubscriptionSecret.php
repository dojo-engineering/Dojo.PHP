...
/**
 * SubscriptionSecret Class Doc Comment
 *
 * @category Class
 * @package  Dojo_PHP
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionSecret implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionSecret';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier for the secret.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The secret value.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The timestamp of the created date, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) UTC format.
     *
     * @return self
     */
     ...
     * Sets is_active
     *
     * @param bool|null $is_active The status of the secret. It can be activated or deactivated.
     *
     * @return self
     */
