...
/**
 * SendEmailReceiptRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Dojo_PHP
 ...
 */
class SendEmailReceiptRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendEmailReceiptRequest';
    ...
    */
     ...
     * Sets emails
     *
     * @param string[] $emails The list of email addresses to which the receipt should be sent.
     *
     * @return self
     */
