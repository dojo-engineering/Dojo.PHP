    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateCustomerRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if (!is_null($email_address) && (mb_strlen($email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling UpdateCustomerRequest., must be smaller than or equal to 254.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling UpdateCustomerRequest., must be smaller than or equal to 50.');
        }
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 5)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling UpdateCustomerRequest., must be bigger than or equal to 5.');
        }
    ...
    public function setVatNumber($vat_number)
    {
        ...
        if (!is_null($vat_number) && (mb_strlen($vat_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $vat_number when calling UpdateCustomerRequest., must be smaller than or equal to 50.');
        }
