...
/**
 * TerminalSessionReceiptLineType Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class TerminalSessionReceiptLineType
{
    /**
    ...
    public const LOGO_IMAGE = 'LogoImage';

    public const NEW_LINE = 'NewLine';

    public const SINGLE_LINE_SEPERATOR = 'SingleLineSeperator';

    public const DOUBLE_LINE_SEPERATOR = 'DoubleLineSeperator';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::LOGO_IMAGE,
            self::NEW_LINE,
            self::SINGLE_LINE_SEPERATOR,
            self::DOUBLE_LINE_SEPERATOR
        ];
    }
}
